 ...
 */
export const getFormattedRam = (mem) => mem < 1000 ? `${mem} MiB` : `${Math.floor(mem / 1000).toFixed(0)} GiB`;
 ...
 */
export const getFormattedPrice = (price) => (price * 41.904).toFixed(2);
 ...
 */
export const pluralize = (dependency, singularWord) => dependency > 1 ? `${singularWord}s` : singularWord;